...
<body>
    ...
    <div class="continerWrapper">
        <div class="header">
            ...
            <ul class="menu">
                <li><a href="/"">HOME</a></li>
                <li><a href="/template/products">PRODUCTS</a></li>
        ...
        <footer>
            ...
            <div class="img"><svg class="icon icon-facebook-with-circle">
                    <use xlink:href="#icon-facebook-with-circle"></use>
                </svg><svg class="icon icon-twitter-with-circle">
                    <use xlink:href="#icon-twitter-with-circle"></use>
                </svg><svg class="icon icon-google+-with-circle">
                    <use xlink:href="#icon-google+-with-circle"></use>
                </svg><svg class="icon icon-pinterest-with-circle">
                    <use xlink:href="#icon-pinterest-with-circle"></use>
                </svg></div>
...
<div class="modal1 a">
    <div class="modal-content1">
        <span class="close">&times;</span>
                ...
                <form  method="POST" action="/template/main/login" enctype="multipart/form-data">
                     ...
                     <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" name="password" class="form-control login" id="exampleInputPassword1" placeholder="Password"  required>
                        </div>
                        <div class="form-group registration">
