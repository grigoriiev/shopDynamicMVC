...
<body>
    ...
    <div class="continerWrapper">
        ...
        <div class="trending-products">
            <ul class="products-list trending-list">
                <li class="no-border"><a href="#">classic</a></li>
                <li class="no-border"><a href="#">modern</a></li>
                <li class="no-border"><a href="#">furniture</a></li>
...
?>
         <a href="/views/productdetail/<?php echo $value['id'] ?>">
<div class="product1"  style="background-image:url(<?php echo $value['minpath']?>)"></div>
                </a>
<?php
}
?>
